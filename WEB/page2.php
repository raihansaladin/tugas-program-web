        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 hero-media">
              <img src="dummies/batas.jpg" alt="Education" class="img-fluid main-image">
              <img src="dummies/wilayah.jpg" alt="Education" class="img-fluid main-image">
            </div>
            <div class="col-lg-6 hero-content">
              <h1>Topografi Desa Bungi dan Kec. Tinanggea</h1>
              <?php echo $lengs[0]?>
            </div>
          </div>
        </div>
